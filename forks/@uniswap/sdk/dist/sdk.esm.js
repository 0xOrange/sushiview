...
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddress = function getAddress(FACTORY_ADDRESS, INIT_CODE_HASH, tokenA, tokenB) {
    ...
    if (pairCache === undefined || (pairCache === null || pairCache === void 0 ? void 0 : (_pairCache$tokens$0$a = pairCache[tokens[0].address]) === null || _pairCache$tokens$0$a === void 0 ? void 0 : _pairCache$tokens$0$a[tokens[1].address]) === undefined) {
      ...
      FACTORY_CACHE[FACTORY_ADDRESS] = _extends({}, pairCache, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, pairCache === null || pairCache === void 0 ? void 0 : pairCache[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = getCreate2Address(FACTORY_ADDRESS, keccak256(['bytes'], [pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), INIT_CODE_HASH), _extends2)), _extends3));
    }
...
var Trade = /*#__PURE__*/function () {
  ...
  Trade.exactIn = function exactIn(FACTORY_ADDRESS, INIT_CODE_HASH, route, amountIn) {
    return new Trade(FACTORY_ADDRESS, INIT_CODE_HASH, route, amountIn, TradeType.EXACT_INPUT);
  }
  /**
  ...
  Trade.exactOut = function exactOut(FACTORY_ADDRESS, INIT_CODE_HASH, route, amountOut) {
    return new Trade(FACTORY_ADDRESS, INIT_CODE_HASH, route, amountOut, TradeType.EXACT_OUTPUT);
  }
  /**
  ...
  currentPairs, originalAmountIn, bestTrades) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountOut.token.equals(tokenOut)) {
        sortedInsert(bestTrades, new Trade(FACTORY_ADDRESS, INIT_CODE_HASH, new Route([].concat(currentPairs, [pair]), originalAmountIn.currency, currencyOut), originalAmountIn, TradeType.EXACT_INPUT), maxNumResults, tradeComparator);
  ...
  currentPairs, originalAmountOut, bestTrades) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountIn.token.equals(tokenIn)) {
        sortedInsert(bestTrades, new Trade(FACTORY_ADDRESS, INIT_CODE_HASH, new Route([pair].concat(currentPairs), currencyIn, originalAmountOut.currency), originalAmountOut, TradeType.EXACT_OUTPUT), maxNumResults, tradeComparator);
      } else if (maxHops > 1 && pairs.length > 1) {
