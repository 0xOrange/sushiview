...
var Pair = /*#__PURE__*/ (function () {
  function Pair(FACTORY_ADDRESS, INIT_CODE_HASH, tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(
      ...
      Pair.getAddress(FACTORY_ADDRESS, INIT_CODE_HASH, tokenAmounts[0].token, tokenAmounts[1].token),
      18,
      'UNI-V2',
      'Uniswap V2'
    )
  ...
  _proto.getOutputAmount = function getOutputAmount(FACTORY_ADDRESS, INIT_CODE_HASH, inputAmount) {
    ...
    return [
      outputAmount,
      new Pair(FACTORY_ADDRESS, INIT_CODE_HASH, inputReserve.add(inputAmount), outputReserve.subtract(outputAmount)),
    ]
  }
...
var Trade = /*#__PURE__*/ (function () {
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance) {
    ...
    if (this.tradeType === exports.TradeType.EXACT_OUTPUT) {
      ...
      var slippageAdjustedAmountOut = new Fraction(ONE).add(slippageTolerance).invert().multiply(this.outputAmount.raw)
        .quotient
